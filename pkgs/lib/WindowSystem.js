  ...
  data: {
    ...
    win: class Win {
      ...
      createWindow() {
        ...
        thisWin.style.width = window.innerWidth + "px";
        thisWin.style.height = window.innerHeight + "px";
        ...
        //   left = (window.screen.width - parseInt(this.options.width)) / 2;
        // else thisWin.style.left = this.options.left;
        // if (this.options.top === "center")
        //   top = (window.screen.height - parseInt(this.options.height)) / 2;
        // else top = this.options.top;

        // window.electronAPI.setPos({
        //   top: top,
        //   left: left,
        // });
        ...
        let titlebar = thisWin.querySelector(".win-titlebar");
        titlebar.style.display = "none";
        window.electronAPI.setTitle(this.options.title);
